package com.qyy.jyshop.seller.common.interceptor;
...
import com.qyy.jyshop.seller.common.supper.DataCache;
...
public class MaliciousRequestInterceptor extends HandlerInterceptorAdapter {
	...
	private final static int maxMaliciousTimes = 500; // 允许的最大恶意请求次数(5次)
