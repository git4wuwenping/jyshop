package com.qyy.jyshop.seller.chat.controller;
...
public class ChatController {
    ...
    public String preSendInfo(Map<String, Object> returnMap) {
        ...
        String interfaceUrl="http://192.168.146.128:5555";
        String strUser=restTemplate.getForEntity(interfaceUrl+"/member/anon/queryChatUser?outId="+authUser.getComId(), String.class).getBody();
        ...
        if(authUser!=null){
            ...
            returnMap.put("comId", authUser.getComId());
        }
    ...
    public ModelAndView preMemberChatDetails(@PathVariable("memberId")Long memberId,ModelMap model) {
        model.put("member", this.memberService.queryByMemberId(memberId));
