package com.qyy.jyshop.seller.store.controller;
...
import com.qyy.jyshop.seller.store.service.StoreService;
...
public class StoreController extends BaseController {
	 ...
	 * @date 2018年3月22日
	 */
	@ControllerLog("修改货品库存")
    @RequestMapping("editStore")
    @Authority(opCode = "04050103", opName = "修改货品库存")
	@ResponseBody
