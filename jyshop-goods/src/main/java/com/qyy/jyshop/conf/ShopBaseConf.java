...
public class ShopBaseConf /* implements CommandLineRunner */{
     ...
     * redisDao.saveObject("shopParam:coinParamConfig", coinParamConfig);
     * OrderParamConfig orderParamConfig =
     * orderParamConfigDao.selectAll().get(0);
     * redisDao.saveObject("shopParam:orderParamConfig", orderParamConfig);
     * ProfitParam profitParam = profitParamDao.selectAll().get(0);
     * redisDao.saveObject("shopParam:profitParam", profitParam);
     * 
