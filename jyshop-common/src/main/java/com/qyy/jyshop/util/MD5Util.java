...
public class MD5Util {
	...
	public static boolean checkPwd(String pwd, String md5pwd)throws Exception {
		if(StringUtil.isEmpty(pwd) || StringUtil.isEmpty(md5pwd))
			return false;
		if (MD5Util.encrypt(pwd).equals(md5pwd))
			return true;
		else
			return false;
	}
	...
	public static void main(String[] args) {
		try {
			System.out.print(MD5Util.encrypt("654321"));
		} catch (Exception e) {
