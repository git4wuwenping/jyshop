...
public class SMSUtil {
	...
	private static String ACCESS_KEY_ID="LTAIwEOwGCLWEaoF";
	private static String ACCESS_KEY_SECRET="VLWiu6m9613GxQTwFBl8rj8ODcvuCI";
	private static String SIGN_NAME="巨柚商城";
	 ...
	 */
/*	public static void postSendMsg(String mobile,String code,String tempId){
		...
		try{
	        ...
	        request.setTemplateCode(tempId);//控制台创建的模板CODE
...
//	        SingleSendSmsResponse httpResponse = client.getAcsResponse(request);
	...
	public static SendSmsResponse postSendMsg(String mobile,String code,String tempId) throws ServerException, ClientException{
	    //设置超时时间-可自行调整
