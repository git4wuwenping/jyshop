...
public class Order implements Serializable {
    ...
    private Integer orderType; // 订单类型 0普通订单 1海外订单 2活动订单
    ...
    @Column(name = "is_shopkeeper_order")
    private Integer isShopkeeperOrder;// 分润状态
    ...
    private String memberCardId; //用户身份证ID
    ...
    public Integer getIsShopkeeperOrder() {
        return isShopkeeperOrder;
    }

    public void setIsShopkeeperOrder(Integer isShopkeeperOrder) {
        this.isShopkeeperOrder = isShopkeeperOrder;
    }
