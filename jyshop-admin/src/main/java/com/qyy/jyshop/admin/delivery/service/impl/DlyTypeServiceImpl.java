...
public class DlyTypeServiceImpl extends AbstratService<DlyType> implements DlyTypeService {
    ...
    public String addDlyType(Map<String, Object> map) {
        ...
        String[] areaIdArr = request.getParameterValues("area_district_ids");
        String[] areaNameArr = request.getParameterValues("area_district_names");
        ...
        if(idArr!=null && idArr.length > 0){
            ...
            for(int i = 0; i<idArr.length; i++){
                ...
                if(StringUtils.isBlank(idArr[i])){
                    ...
                    dlyTypeArea.setId(Long.parseLong(idArr[i]));
