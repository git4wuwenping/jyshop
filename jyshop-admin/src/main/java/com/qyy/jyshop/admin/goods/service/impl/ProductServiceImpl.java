        ...
        if(productSnArray != null && productSnArray.length > 0){
            ...
            for (int i = 0; i < productSnArray.length; i++) {
                ...
                if(product == null){
                    ...
                    System.out.println("priceArray[i]:"+priceArray[i]);
                    System.out.println("new BigDecimal(priceArray[i]):"+new BigDecimal(priceArray[i]));
                    System.out.println("11111:"+new BigDecimal(priceArray[i]).setScale(2, BigDecimal.ROUND_DOWN));
