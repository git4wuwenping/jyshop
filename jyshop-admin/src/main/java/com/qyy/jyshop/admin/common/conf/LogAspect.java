...
import com.qyy.jyshop.admin.common.service.LogService;
...
public class LogAspect {
	...
	// Service层切点
	@Pointcut("@annotation(com.qyy.jyshop.admin.common.annotation.ServiceLog)")
	public void serviceAspect() {
	}

	// Controller层切点
	@Pointcut("@annotation(com.qyy.jyshop.admin.common.annotation.ControllerLog)")
