...
@Component
public class GiftOrderTag extends AbstractMarkupSubstitutionElementProcessor {
...
//        final String orderId = element.getAttributeValue("order_id");
        ...
        if(!StringUtil.isEmpty(orderId)){
            ...
            GiftOrderDao giftOrderDao=SpringContextUtils.getBean(GiftOrderDao.class);
            GiftOrder order=giftOrderDao.selectByOrderIdNoSplit(Long.valueOf(orderId));
